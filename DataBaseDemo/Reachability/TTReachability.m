...
NSString *kkReachabilityChangedNotification = @"kkReachabilityChangedNotification";
...
- (TTNetworkStatus)networkStatusForFlags:(SCNetworkReachabilityFlags)flags
{
    ...
    TTNetworkStatus returnValue = TTNotReachable;
	...
	if ((flags & kSCNetworkReachabilityFlagsConnectionRequired) == 0)
	{
         ...
         */
		returnValue = TTReachableViaWiFi;
	}
	...
	if ((flags & kSCNetworkReachabilityFlagsIsWWAN) == kSCNetworkReachabilityFlagsIsWWAN)
	{
         ...
         */
		returnValue = TTReachableViaWWAN;
	}
